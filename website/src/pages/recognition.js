...
const AwardsPage = () => (
  <div className={styles.pagecontainer}>
    ...
    <ul>
      ...
      <li>The “Society Award”  of the IEEE Signal Processing Society, 2008. This is the highest and most prestigious award of this society, emphasizing technical leadership and achievements in the field.</li>
    ...
    <ul>
      ...
      <li>Co-recipient of the prestigious “Excellence in Neural Engineering Award” 2005, from the IEEE-EMBS Neural Engineering Conference and sponsored by the National Science Foundation, Office of Naval Research Global and IEEE-EMBS. This was the highest paper award given at the conference emphasizing innovative projects integrating engineering and neuroscience. The paper title is “A New Design of the Computer Interface Using the Knowledge of the Path of Features,” coauthored by A. Bashashati, myself and G. Birch</li>
      <li>The Best Paper Award in the Inter. Conf. on Information Technology Research and Education, New Jersey, USA, August 2003, “A Robust Method for Fitting the (Sigma, Rho) Model to a Traffic Source.”</li>
      <li>The Best Paper Award with my student P. Mousavi at the IEEE Engineering in Medicine and Biology International Conference, July 2000.</li>
      <li>Best Student Paper Award went to my student P. Mousavi for the paper "Feature Analysis and Classification of Homologous Chromosome lbs Using Fluorescence Microscopy Images" co-authored by myself, IEEE CCECE Conference 1999</li>
      <li>Four Best Paper Awards of the, BC Advanced Systems Institute Exchange: These were:
        <ul>
    ...
    <li>Won the American University of Beirut Scholarship award to study medicine (but declined it because I wanted to study engineering. Women were not allowed at that time to study engineering at the American University of Beirut in 1961).</li>
    </ul>
  </div>
)
