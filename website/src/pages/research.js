  ...
  render() {
    return(
      <div className={styles.pagecontainer}>
        ...
        >
          <ul>
            <li>Single slice MR imaging from single and multiple K-space scans</li>
            <li>Quantitative MR imaging</li>
            <li>Combining signal processing and physics-based techniques for parallel MRI</li>
            <li>Dynamic MRI</li>
          </ul>
        </Research>
        <Research
        ...
        <ul>
          ...
          <li>Invited Speaker: Emerging topics in Signal Processing, IEEE Section in Muscat, Oman, Dec. 2016</li>
          <li>Invited Speaker: Deep Learning and applications, IEEE Buenos Aires Section, Argentina and in IEEE Santiago, Chile, January 2016.</li>
          <li>Keynote Speaker: Emerging Applications in Signal Processing in the “Visual Signal Analysis and Processing” workshop, Abu Dhabi, November 9-10, 2015.</li>
          <li>Invited Speaker: IEEE Chengdu Section, IEEE Beijing Section, Tsinghua University.</li>
          <li>Keynote Speaker: Future of Broadcasting at the Emerging Technology Workshop, the Communication University of China, July 2015.</li>
          <li>Keynote speaker: Skills for women success in Engineering, Women in Engineering Luncheon, ICASSP 2015, Brisbane, Australia, April 2015.</li>
          <li>Invited Speaker, Graduate School Information Night for Undergraduate Students in Engineering and       Science, April 2010, Undergraduate Engineering Student Association.</li>
          <li>Keynote speaker, Inspirational Speaker Night, Women in Engineering Society in collaboration with Society of Women in Science and Technology, April 26, 2009.</li>
          <li>Keynote speaker of the California Lebanese Ladies Society’s Gala, Los Angeles, May 2004.</li>
          <li>Guest speaker at the Research Mentoring Dinner, organized by the UBC VP Research office and St. John’s College, entitled “Research Topics, Students, Publishing and Multi-disciplinarity”, November 20, 2002.</li>
          <li>Gave a lecture entitled “In Praise of Engineering” at a Public Science Forum organized by the Canadian Academy for the Advancement of Science at Mulgrave High School, West Vancouver, November 18, 2002.</li>
          <li>Keynote Speaker, UBC Applied Sciences Seminar on Engineering for Women, May 2000.</li>
          <li>Invited talk at the University of Waterloo on " Automatic Monitoring of cable TV Picture Performance ", 1999</li>
          <li>Gave a speech entitled, “Information Revolution and Societal Change” at a Public Science Forum of the Canadian Academy for the Advancement of Science, March 28, 1998, Robson Square Conference Centre, Vancouver.</li>
          <li>Invited Talk on “Video Noise Reduction”, April 11, 1997, University of Waterloo. </li>
          <li>Gave a seminar entitled “Emerging Trends in Multimedia” at the UBC Applied Science Speaker Series, UBC, Feb. 1997</li>
          <li>Gave a one-hour interview to Lebanese television, September 1996, on women and engineering. </li>
          <li>One of three panelists on challenges facing women grad students in engineering (March 1996).</li>
          <li>Speaker for UBC, CICSR Distinguished Lecturer Series, Home Base Seminar, Feb. 21, 1995.</li>
          <li>Presented our work to the President of Sanyo, California, US, who visited our lab for discussions about relevant work, July 16, 1994.</li>
          <li>Invited by Rogers Inc. to present my work on cable TV to selected engineers in the National Cable Television Association, San Francisco, June 6-9, 1993. As a result, I was invited to address the technical committee of the National Cable TV Association, June 30-July 1, 1993, Washington, D.C.</li>
          <li>Invited by Techtronix (Portland, Oregon), as a distinguished guest, met with the vice-president of engineering and senior engineers, gave a two-hour seminar attended by over 100 of their engineers, and conducted many discussions with their engineers about common work, January 1993.</li>
          <li>I address, on a regular basis, the Faculty of Applied Science Conference for Women&#39;s senior secondary school students. The aim of this one-day long conference is to encourage high school girls to consider engineering as a career. Many of our current female engineering students have noted their intentions to join the engineering school only after having heard my speeches and shared discussions.</li>
          <li>Guest lecturer, Shad Valley Program, June 1991 & July 1994 hosted the whole group, August 1999</li>
          <li>I gave various newspaper and radio interviews about engineering and women, e.g. in 1990-91, I appeared twice on CBC TV News, the first time was regarding the Montreal massacre and the second time was about the attitude of engineering students towards women and minorities.</li>
          <li>I have given public talks on a continuous basis, and for many years, to various women's groups and high school female students about Women in Engineering. Last year I addressed the Vancouver Female Careers Day in Killarney School, and was one of the three panel speakers for the York House students' presentation organized by the UBC School and College Liaison Office.</li>
          <li>One of three panelists, "A Day in Science", organized by UBC School and College Liaison Office for high school women students, May 1990.</li>
          <li>Main speaker, UBC Applied Science Women in Engineering Conference, April 1990, April 1991, April 1992, April 1993.</li>
          <li>Speaker at the annual meeting of the cable TV lab, April 1990, May 1992, April 1993, April 1994, April 1995, May 1996, and May 1997.</li>
          <li>"Electricity Demand for Zimbabwe", February 1982. Organized by the UBC Simulation and Modelling Seminar.</li>
          <li>Gave two public lectures and a condensed course on “Digital Image Processing” to practicing professional engineers in Zimbabwe. July, 1989.</li>
          <li>Invited to give a seminar on “Estimation of Signals Distorted by Systems of Random Impulse-Response“ and engaged in discussions with members of the Water Research Center, University of Western Australia. February 1989</li>
          <li>Gave a two public lectures on image processing and condensed course on “Optimization and Non-linear Control”, to practicing professional engineers in Zimbabwe, August 1987.</li>
          <li>"Women in the Scientific Community: Techniques for Survival and Success" February 25, 1982, Organized by the AMS Women&#39;s Committee. </li>
          <li>"Women, Science and Technology", November 1981, the Society of Canadian Women in Science and Technology. </li>
          <li>"Women in Engineering", the University Women Graduates Assoc., May 1979. </li>
          <li>"Energy" in the "Development for Independence" programme by the Development Studies Committee of the University of Rhodesia, February 1979. </li>
          <li>"Operations Research Applications for Rhodesia", the Rhodesian Institution of Engineers, January 1978.</li>
        ...
        <ul>
          ...
          <li>Presented and demonstrated our prototype on “video compression improvement” at the Western Cable TV show, December 2000.</li>
          <li>Presented and demonstrated our prototype on video noise reduction at the Western Cable TV show, December 1997, 1998, and 1999.</li>
          <li>Presented and demonstrated our prototype on video noise reduction at the U.S. Cable Labs Winter meeting, San Diego, CA, February 1997.</li>
          <li>Presented and demonstrated our prototype on video noise reduction in Cablenet, LA, CA, December 1996.</li>
        ...
        <p>Our paper on surveying artifact processing algorithms in brain-computer interface systems was placed amongst the “Top 25 Hottest Articles in Clinical Neurophysiology” three times (in 2007 and 2008).
        </p>
        <p>Our paper on surveying signal processing algorithms in brain computer interface systems received a place in the “Highlights of 2007” in the Journal of Neural Engineering.
        </p>
        <p>Our collaboration from 2008 – 2011 with Vancouver multimedia company BBTV resulted in algorithms that protect the rights of multimedia owners (concerning audio, songs, images, and video assets) from illegal copying and content piracy. BBTV is now developing this technology for commercialization.
        </p>
        <p>My work with Steven Poon has resulted in a Fluorescence microscope-based system which can, for the first time, measure the length of every telomere in every chromosome. This work is now used in research centres worldwide, including the BC Cancer Research Agency and John Hopkins, as well as in Spain, Holland, Germany, and Hong Kong.
        </p>
        <p>My work with Prof. Petrell on a video imagery system for the aquaculture industry, in areas such as salmon farming, was commercialized by Canadian company JB Thompson & Assoc. (1998). The instrument measures in a non-interfering and non-destructive fashion the size, biomass, and swimming speed of fish in cages and tanks.
        </p>
        <p>My work with Dr. Kossentini on video compression has resulted in an algorithm for motion vector estimation which has officially been adopted in the ITU-T H-263+ Standard TMN8 model for video encoding.
        </p>
      </div>
    )
  }
